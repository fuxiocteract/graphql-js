...
function extendSchema(schema, documentAST, options) {
    ...
    if (extensions) {
      extensions.forEach(function (extension) {
        extension.definition.fields.forEach(function (field) {
          ...
          newFieldMap[fieldName] = {
            description: (0, _buildASTSchema.getDescription)(field, options),
  ...
  function buildObjectType(typeNode) {
    return new _definition.GraphQLObjectType({
      ...
      description: (0, _buildASTSchema.getDescription)(typeNode, options),
      interfaces: function interfaces() {
  ...
  function buildEnumType(typeNode) {
    return new _definition.GraphQLEnumType({
      ...
      values: (0, _keyValMap2.default)(typeNode.values, function (enumValue) {
        ...
        return {
          description: (0, _buildASTSchema.getDescription)(enumValue, options),
  ...
  function getDirective(directiveNode) {
    return new _directives.GraphQLDirective({
      ...
      description: (0, _buildASTSchema.getDescription)(directiveNode, options),
  ...
  function buildInputValues(values) {
    return (0, _keyValMap2.default)(values, function (value) {
      ...
      return {
        type: type,
        description: (0, _buildASTSchema.getDescription)(value, options),
